...
const emberStyle = (delay: string | number): React.CSSProperties =>
  ({ ['--delay' as any]: delay } as React.CSSProperties);
    ...
    <StyledWrapper>
      <div className="campfire-loader">
        ...
        <div className="embers">
          <div style={emberStyle(0)} className="ember" />
          <div style={emberStyle('0.3')} className="ember" />
          <div style={emberStyle('0.6')} className="ember" />
        </div>
